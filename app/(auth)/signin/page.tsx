...
export default async function SignIn() {
    ...
    return (
        <div className={cx('relative', styles.wrapper, montserratAlternates.className)}>
            ...
            <div className={'relative'}>
                <div className={styles.titleWrapper} onClick={() => handleToBack()}>
                    <div className={styles.backButtonWrapper}>
                        <ArrowLeft clasName={styles.iconBack} />
                        <div className={cx(montserratAlternates.className, styles.backText)}>Назад</div>
                    </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="179" height="123" viewBox="0 0 179 123" fill="none">
                    <ellipse cx="58.5" cy="7.5" rx="120.5" ry="115.5" fill="#049444"/>
                </svg>
            </div>
